(function () {
    ...
    const CONSTELLATIONS = [
        ...
        },
        {
            // SCORPIUS
            points: [
                { x: 0.340, y: 0.378 }, { x: 0.282, y: 0.372 },
                { x: 0.222, y: 0.380 }, { x: 0.284, y: 0.440 },
                { x: 0.312, y: 0.520 }, { x: 0.372, y: 0.462 },
                { x: 0.392, y: 0.580 }, { x: 0.422, y: 0.635 },
                { x: 0.442, y: 0.682 }, { x: 0.432, y: 0.732 },
                { x: 0.378, y: 0.775 }, { x: 0.302, y: 0.790 },
                { x: 0.232, y: 0.772 }, { x: 0.182, y: 0.730 },
                { x: 0.142, y: 0.712 },
            ],
            edges: [
                [2,1],[1,0],[1,3],[3,4],[4,5],
